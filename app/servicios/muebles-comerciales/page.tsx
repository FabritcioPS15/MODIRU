...
import { ArrowRight, Store, Ruler, ShieldCheck, Star, UserCheck } from 'lucide-react'
...
const features = [
  {
    ...
    desc: 'Diseñamos para guiar y deleitar a tus clientes desde el ingreso hasta la compra.'
  },
  {
    icon: ShieldCheck,
    title: 'Refuerzo de marca',
    desc: 'Muebles que comunican la identidad y los valores de tu negocio.'
  },
  {
    icon: Star,
    title: 'Uso intensivo',
    desc: 'Materiales resistentes pensados para el tráfico constante de un local comercial.'
  },
  {
    icon: UserCheck,
    title: 'Soluciones integrales',
    desc: 'Estanterías, vitrinas, mostradores, exhibidores y mobiliario para tu punto de venta.'
  }
]

export default function MueblesComerciales() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="flex flex-col lg:flex-row bg-[#111111]">
        <div className="w-full lg:w-[45%] p-8 lg:p-20 xl:p-24 flex flex-col justify-center text-white">
          ...
          >
            Muebles comerciales
            <br />
            <span className="text-[#eab308]">que venden por ti</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Diseñamos y fabricamos mobiliario comercial que potencia la experiencia de tus clientes y tu marca. Puntos de venta que convierten visitas en ventas.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <motion.div variants={fadeIn}>
              <span className="text-[#eab308] font-bold text-sm tracking-widest uppercase mb-4 block">MUEBLES COMERCIALES</span>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Tu tienda, tu mejor vendedor
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                El mobiliario de tu local es clave para la experiencia de tus clientes. Un buen diseño atrae, guía y convence. Creamos soluciones para tiendas, restaurantes, clínicas, boutiques y más.
              </p>
              <p className="text-gray-600 leading-relaxed">
                Diseñamos estanterías, vitrinas, mostradores y exhibidores que optimizan tus productos y espacios. Trabajamos para que tu punto de venta refleje la personalidad de tu negocio.
              </p>
            </motion.div>
      ...
      <section className="py-20 md:py-28 bg-[#111111] text-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            {[
              { num: '01', title: 'Entendemos tu marca', desc: 'Analizamos tu negocio, tu producto y tu público objetivo.' },
              { num: '02', title: 'Diseñamos', desc: 'Creamos la propuesta de mobiliario y layout del punto de venta.' },
              { num: '03', title: 'Fabricamos', desc: 'Producimos mobiliario resistente para uso comercial.' },
              { num: '04', title: 'Instalamos', desc: 'Montamos tu local y dejamos todo listo para recibir clientes.' }
            ].map((step, idx) => (
          ...
          >
            <Link href="/contacto">
              <Button className="bg-[#eab308] text-black hover:bg-[#d9a05b] border-none h-12 px-8 text-base font-semibold inline-flex items-center gap-2 transition-colors">
                Equipa tu local <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            variants={fadeIn}
          >
            <Store className="text-[#eab308] w-10 h-10 mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Haz crecer tu negocio
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              Un punto de venta bien diseñado marca la diferencia. Creemos juntos el espacio ideal para tu marca.
            </p>
