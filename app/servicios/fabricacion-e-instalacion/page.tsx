...
import { ArrowRight, Wrench, Ruler, ShieldCheck, Star, UserCheck } from 'lucide-react'
...
const features = [
  {
    ...
    desc: 'Tecnología moderna y control de calidad para un ajuste perfecto en cada pieza.'
  },
  {
    icon: ShieldCheck,
    title: 'Instalación profesional',
    desc: 'Un equipo especializado que cuida tu espacio y garantiza un acabado impecable.'
  },
  {
    icon: Star,
    title: 'Materiales certificados',
    desc: 'Trabajamos con maderas, melaminas y herrajes de reconocida calidad y durabilidad.'
  },
  {
    icon: UserCheck,
    title: 'Limpieza y puntualidad',
    desc: 'Respetamos los plazos acordados y dejamos tu espacio limpio al finalizar.'
  }
]

export default function FabricacionEInstalacion() {
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <section className="flex flex-col lg:flex-row bg-[#111111]">
        <div className="w-full lg:w-[45%] p-8 lg:p-20 xl:p-24 flex flex-col justify-center text-white">
          ...
          >
            ...
            <br />
            <span className="text-[#eab308]">de primera</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            Fabricación con precisión e instalación profesional para garantizar un resultado impecable y duradero. De nuestro taller a tu espacio, con el máximo cuidado.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
        ...
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            <motion.div variants={fadeIn}>
              <span className="text-[#eab308] font-bold text-sm tracking-widest uppercase mb-4 block">FABRICACIÓN E INSTALACIÓN</span>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
                Calidad de inicio a fin
              </h2>
              <p className="text-gray-600 text-lg leading-relaxed mb-6">
                Nuestro taller está equipado con maquinaria moderna que asegura cortes precisos y acabados de calidad. Cada pieza pasa por un riguroso control antes de salir.
              </p>
              <p className="text-gray-600 leading-relaxed">
                La instalación corre a cargo de nuestro equipo especializado, que cuida cada detalle: desde la protección del espacio hasta la nivelación y el ajuste final. Te entregamos un resultado listo para disfrutar.
              </p>
            </motion.div>
            <motion.div variants={fadeIn} className="overflow-hidden rounded-xl">
              <img
                src="https://images.unsplash.com/photo-1531834685032-c34bf0d84c77?q=80&w=2070&auto=format&fit=crop"
                alt="Instalación de mobiliario"
      ...
      <section className="py-20 md:py-28 bg-[#111111] text-white">
        <div className="container mx-auto px-4 md:px-6">
          ...
          >
            {[
              { num: '01', title: 'Fabricación', desc: 'Procesamos los materiales con precisión y control de calidad.' },
              { num: '02', title: 'Control de calidad', desc: 'Verificamos medidas, acabados y herrajes de cada pieza.' },
              { num: '03', title: 'Entrega', desc: 'Trasladamos el mobiliario con el cuidado necesario.' },
              { num: '04', title: 'Instalación', desc: 'Montamos y ajustamos hasta dejar un resultado impecable.' }
            ].map((step, idx) => (
          ...
          >
            <Link href="/contacto">
              <Button className="bg-[#eab308] text-black hover:bg-[#d9a05b] border-none h-12 px-8 text-base font-semibold inline-flex items-center gap-2 transition-colors">
                Empezar mi proyecto <ArrowRight className="w-4 h-4" />
              </Button>
            </Link>
          </motion.div>
        </div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <motion.div
            ...
            variants={fadeIn}
          >
            <Wrench className="text-[#eab308] w-10 h-10 mx-auto mb-6" />
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6">
              Hecho para durar
            </h2>
            <p className="text-gray-600 text-lg leading-relaxed mb-8">
              De la mano del diseño a la fabricación e instalación, cuidamos cada detalle para que tu mobiliario te acompañe por años.
            </p>
